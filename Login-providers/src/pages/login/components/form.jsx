    ...
    return(
        ...
        style={{ boxShadow:"0px 2px 4px -1px rgba(0,0,0,0.2), 0px 4px 5px 0px rgba(0,0,0,0.14), 0px 1px 10px 0px rgba(0,0,0,0.12", alignItems:"center",justifyContent:"center", textAlign:"center"}}>
            ...
            <Grid container flexDirection="column" justifyContent="center" alignItems="center" textAlign="center">
                <Input id="name" label="Nombre y apellido:" type="text" changeProp={handleChange} isRequired={true}/>
                <Input id="adress" label="Domicilio:" type="text" changeProp={handleChange} isRequired={true}/>
                <InputSelect changeProp={handleChange}/>
                <Input id="username" label="Usuario:" type="text" changeProp={handleChange} isRequired={true}/>
                <Input id="key" label="Clave:" type="password" changeProp={handleChange} isRequired={true}/>
            </Grid>
